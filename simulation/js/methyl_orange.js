...
function draw() {console.log("MouseX: " + mouseX + ", MouseY: " + mouseY);
  ...
  push();
  if (dropAdded) {
    tint(239, 243, 245,210 );
  }
  image(liquid, 415, 462, 70, 20);
  pop();
  image(frontflask, 390, 325, 120, 160);
  ...
  image(image1, 505, 245, 165, 200);
  image(image2, 515, 320,150,180);
  //For Cap animation
  if (process1 == 1) {
    // Calculate step values for x and y
