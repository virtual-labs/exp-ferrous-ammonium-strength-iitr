...
function draw() {console.log("MouseX: " + mouseX + ", MouseY: " + mouseY);
  ...
  image(liquid, 400, 453, 60, 20);
  
  
  pop();
  image(frontflask, 350, 270, 200, 210);
  image(Coolent, 375, 385, 150, 150);
  ...
  image(image1, 503, 220, 170, 210);
  image(Coolent, 520, 335,150,150);
  //For Cap animation
  if (process1 == 1) {
    // Calculate step values for x and y
